#!/bin/bash
#exp1
python display_random_search_results.py --DB tunnel --ACTION table --BUDGET 1700 --TOP 5 --METRIC global_score_no_weak_acc --DATASET dwtc --DESTINATION ../../win_transfer/ds-active_learning/results/table_500_dwtc_global_score_no_weak_acc&
#exp2
python display_random_search_results.py --DB tunnel --ACTION table --BUDGET 1700 --TOP 5 --METRIC global_score_with_weak_acc --DATASET dwtc --DESTINATION ../../win_transfer/ds-active_learning/results/table_500_dwtc_global_score_with_weak_acc&
#exp3
...
# exp6
python display_random_search_results.py --DB tunnel --ACTION compare_rec --BUDGET 1510 --TOP 1 --METRIC acc_test --DATASET dwtc --DESTINATION ../../win_transfer/ds-active_learning/results/compare_rec_500_dwtc_acc_test&
python display_random_search_results.py --DB tunnel --ACTION compare_rec --BUDGET 1510 --TOP 1 --METRIC fit_score --DATASET dwtc --DESTINATION ../../win_transfer/ds-active_learning/results/compare_rec_500_dwtc_fit_score&

# exp7 multi
python display_random_search_results.py --DB tunnel --ACTION compare_all --BUDGET 1510 --TOP 1 --METRIC global_score_no_weak_acc --DESTINATION ../../win_transfer/ds-active_learning/results/compare_all_500_fit_score&
...
#fit
python display_random_search_results.py --DB tunnel --DATASET dwtc --ACTION plot --BUDGET 1510  --METRIC fit_score --TOP 0 --DESTINATION ../../win_transfer/ds-active_learning/results/dwtc_1000_top_0&
...
python display_random_search_results.py --DB tunnel --DATASET dwtc --ACTION plot --BUDGET 1510  --METRIC acc_test --TOP 0 --DESTINATION ../../win_transfer/ds-active_learning/results/dwtc_1500_top_0_acc&
